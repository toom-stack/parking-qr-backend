...
__export(index_exports, {
  ...
  download: () => import_chunk_KMRGDG6B.download,
  engineEnvVarMap: () => import_chunk_XNR2KDTK.engineEnvVarMap,
  getBinaryEnvVarPath: () => import_chunk_XNR2KDTK.getBinaryEnvVarPath,
  getBinaryName: () => import_chunk_KMRGDG6B.getBinaryName,
  getCacheDir: () => import_chunk_4MDZEOKU.getCacheDir,
  getProxyAgent: () => import_chunk_CTLNI6CP.getProxyAgent,
  getVersion: () => import_chunk_KMRGDG6B.getVersion,
  maybeCopyToTmp: () => import_chunk_KMRGDG6B.maybeCopyToTmp,
  overwriteFile: () => import_chunk_4MDZEOKU.overwriteFile,
  plusX: () => import_chunk_KMRGDG6B.plusX,
  vercelPkgPathRegex: () => import_chunk_KMRGDG6B.vercelPkgPathRegex
});
module.exports = __toCommonJS(index_exports);
var import_chunk_KMRGDG6B = require("./chunk-KMRGDG6B.js");
